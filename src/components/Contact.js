...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (result.code === 200) setStatus({ succes: true, message: 'Message sent successfully' })
        else setStatus({ succes: false, message: 'Something went wrong, please try again later.' })
    }
